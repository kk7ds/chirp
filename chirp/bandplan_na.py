...
GMRS_LOW = [462562500, 462587500, 462612500, 462637500, 462662500,
            462687500, 462712500]
GMRS_FRSONLY = [467562500, 467587500, 467612500, 467637500, 467662500,
                467687500, 467712500]
GMRS_HIRPT = [462550000, 462575000, 462600000, 462625000, 462650000,
              462675000, 462700000, 462725000]
ALL_GMRS_FREQS = GMRS_LOW + GMRS_FRSONLY + GMRS_HIRPT


# US MURS Frequencies
MURS_NFM = [151820000, 151880000, 151940000]
MURS_FM = [154570000, 154600000]
ALL_MURS_FREQS = MURS_NFM + MURS_FM
