...
@directory.register
class RadiodditysetGM30(chirp_common.CloneModeRadio):
    """Radioddity GM30"""
    VENDOR = "Radioddity"
    MODEL = "GM30"
    BAUD_RATE = 57600
    ...
    def get_str_name(self, _name):
        return "".join(chr(int(i)) if 31 < int(i) < 127
                       else ' ' for i in _name)
    ...
    def get_memory(self, number):
        ...
        mem.tuning_step = self.VALID_STEPS[0x0]  # step 2.5k only
        mem.immutable = ["tuning_step"]
