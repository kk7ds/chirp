...
class TDH8(chirp_common.CloneModeRadio):
    ...
    def sync_in(self):
        ...
        # HAM OR GMRS
        print(MODE_RADIO)
        if MODE_RADIO == 'P31184': #gmrs
            self._memobj.settings.ham = 0
            self._memobj.settings.gmrs = 1
        else:
            msg = ("Please check your walkie-talkie mode, the current mode is not GMRS mode.")
    ...
    def set_memory(self, mem):
        ...
        for setting in mem.extra:
            if setting.get_name() == 'scanadd':
                ...
                if MODE_RADIO == "P31184" and mem.number >= 189 and mem.number <= 199:
