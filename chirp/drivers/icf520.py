"""
Icom IC-F520/IC-F620 Series Land Mobile Radio
"""
...
class ICF621Radio(chirp_common.Alias):
    """
    Icom IC-F621 UHF Land Mobile Radio
    45 Watt version of IC-F560
    """
    VENDOR = "Icom"
    MODEL = "IC-F621"
...
class ICF620Radio(chirp_common.Alias):
    """
    Icom IC-F620 UHF Land Mobile Radio
    UHF version of IC-F520
    """
    VENDOR = "Icom"
    MODEL = "IC-F620"


class ICF521Radio(chirp_common.Alias):
    """
    Icom IC-F521 UHF Land Mobile Radio
    50 Watt version of IC-F520
    """
    VENDOR = "Icom"
    MODEL = "IC-F521"
    _power_high = chirp_common.PowerLevel("High", watts=50)


@directory.register
class ICF520Radio(icf.IcomCloneModeRadio):
    """
    Icom IC-F520 VHF Land Mobile Radio
    """
    ...
    _power_high = chirp_common.PowerLevel("High", watts=25)
...
# Radio Settings
    ...
    def _get_set_mode_group(self):
        ...
        _group.append(RadioSetting(
            ...
            RadioSettingValueList(
                YES_NO_CHOICE, current_index=int(
